...
class ccData:
    ...
    Description of cclib attributes:
        ...
        ci -- configuration interaction specifications (dict of arrays)
        ...
        wfn_info -- wavefunction information (dict)
    ...
    _attributes = {
       ...
       "ci":               Attribute(dict,             'CI',                          'properties'),
       ...
       "wfn_info":         Attribute(dict,             'Wavefunction information',    'properties'),
